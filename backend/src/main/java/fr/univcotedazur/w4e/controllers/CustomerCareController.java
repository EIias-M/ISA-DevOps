...
import fr.univcotedazur.w4e.interfaces.CustomerFinder;
import fr.univcotedazur.w4e.interfaces.CustomerRegistration;
...
public class CustomerCareController {
    ...
    private static CustomerDTO convertCustomerToDto(Customer customer) { // In more complex cases, we could use a ModelMapper such as MapStruct
        return new CustomerDTO(customer.getId(), customer.getName(), customer.getCreditCard(), customer.getPointfidele());
    }
